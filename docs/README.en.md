...
This file is a **short landing page** for English readers. The detailed **deployment, development, monorepo layout, CI, license, commercial terms, email, and community (WeChat QR)** live in the **[root README.md](../README.md)** (start at **「Monorepo（Rust + Flutter）」**) and **[LICENSE](../LICENSE)**.

- **Backend:** [`backend/README.md`](../backend/README.md)
- **Frontend:** [`frontend/README.md`](../frontend/README.md)
- **Roadmap:** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
