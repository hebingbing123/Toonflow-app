...
OpenFlow поддерживает следующие языки интерфейса:
...
OpenFlow — инструмент для создания коротких сериалов и комиксов с помощью AI, позволяющий автоматически превращать романы в сценарии и генерировать изображения и видео с помощью нейросетей. Используя OpenFlow, вы легко пройдёте путь от текста к видео: создание коротких фильмов становится умнее и удобнее.
...
**OpenFlow: 8 минут до полного освоения AI-видео**
...
## Актуальная документация (2026)

Этот файл — **краткая вводная страница**. Подробности **развёртывания, разработки, структуры monorepo, CI, лицензии, коммерческих условий, контактов и сообщества (WeChat)** — в **[README.md](../README.md)** в корне репозитория (раздел **「Monorepo（Rust + Flutter）」**) и в **[LICENSE](../LICENSE)**.

- **Бэкенд:** [`backend/README.md`](../backend/README.md)
- **Фронтенд:** [`frontend/README.md`](../frontend/README.md)
- **Дорожная карта:** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
