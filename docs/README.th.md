...
ไฟล์นี้เป็น**หน้า landing สั้น ๆ** รายละเอียด **การดีพลอย/พัฒนา โครง monorepo CI ใบอนุญาต ข้อกำหนดเชิงพาณิชย์ การติดต่อ และชุมชน (WeChat)** อยู่ที่ **[README.md](../README.md)** ที่รากรีโป (เริ่มจาก **「Monorepo（Rust + Flutter）」**) และ **[LICENSE](../LICENSE)**

- **แบ็กเอนด์:** [`backend/README.md`](../backend/README.md)
- **ฟรอนต์เอนด์:** [`frontend/README.md`](../frontend/README.md)
- **แผนงาน:** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
