...
## Tài liệu hiện tại (2026)

File này là **trang giới thiệu ngắn**. Chi tiết **triển khai, phát triển, cấu trúc monorepo, CI, giấy phép, điều khoản thương mại, liên hệ và cộng đồng (WeChat)** nằm ở **[README.md](../README.md)** gốc repo (mục **「Monorepo（Rust + Flutter）」**) và **[LICENSE](../LICENSE)**.

- **Backend:** [`backend/README.md`](../backend/README.md)
- **Frontend:** [`frontend/README.md`](../frontend/README.md)
- **Lộ trình:** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
