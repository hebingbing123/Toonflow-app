...
All job creation entry points in the Openflow backend have been audited. The canonical `resolve_billing_workspace_id` function has been implemented and is correctly used by all active job creation paths. No additional changes are required for Task 2.1.
