...
- **下一大型竖切**（进行中）：**团队 Workspace 完整功能** — **W2.1–W2.8 已落地（成员直加、邀请 token、改角色/移除、主动离开、审计、限流）**，继续 **W2.9（Runbook 与契约补齐）** 见 [**`workspace-team-full-plan.md`**](./workspace-team-full-plan.md)
