...
- **下一大型竖切**（进行中）：**团队 Workspace 完整功能** — **Phase W2、W3 已收口**；**W4.1–W4.3 已落地**（项目列表/创建/详情编辑删除按 workspace 作用域），继续 W4.4+，见 [**`workspace-team-full-plan.md`**](./workspace-team-full-plan.md)
