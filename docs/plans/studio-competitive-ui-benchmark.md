...
| 维度 | waoowaoo | LumenX | huobao-drama | Toonflow（当前 Harness） | Toonflow（目标 Studio） |
|------|----------|--------|--------------|--------------------------|-------------------------|
...
| 步骤 | waoowaoo | LumenX | huobao | Toonflow Harness | Toonflow Studio（目标） |
|------|----------|--------|--------|------------------|-------------------------|
...
4. Toonflow Harness vs `main_product` / Studio Shell  
