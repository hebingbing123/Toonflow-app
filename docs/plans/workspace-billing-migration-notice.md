...
This document informs API consumers, client developers, and operations teams about the **transition from user-scope to workspace-scope billing** for Toonflow. This migration affects how subscriptions, quotas, and usage are attributed and enforced.
