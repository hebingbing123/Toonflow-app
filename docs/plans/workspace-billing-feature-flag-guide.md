...
flutter run \
  ...
  --dart-define=API_BASE_URL=https://staging.toonflow.com
```
...
curl https://api.toonflow.com/api/v1/me?v=2

# Check API base URL in app
flutter run --dart-define=API_BASE_URL=https://staging.toonflow.com
