...
本頁僅作繁體入口；**部署、開發、目錄結構、CI、許可證與商業條款、聯繫方式與微信社群**等完整內容請以倉庫根目錄 **[README.md](../README.md)**（自「**Monorepo（Rust + Flutter）**」一節起）及 **[LICENSE](../LICENSE)** 為準。

- **後端：** [`backend/README.md`](../backend/README.md)
- **前端：** [`frontend/README.md`](../frontend/README.md)
- **路線圖：** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
