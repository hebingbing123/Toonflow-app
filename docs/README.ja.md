...
本ファイルは**短い入口**です。**デプロイ、開発、モノレポ構成、CI、ライセンス・商用条項、連絡先・コミュニティ（WeChat）**の詳細は、リポジトリルートの **[README.md](../README.md)**（「**Monorepo（Rust + Flutter）**」以降）および **[LICENSE](../LICENSE)** を参照してください。

- **バックエンド:** [`backend/README.md`](../backend/README.md)
- **フロント:** [`frontend/README.md`](../frontend/README.md)
- **ロードマップ:** [`docs/plans/harness-rust-flutter.md`](plans/harness-rust-flutter.md)
