  ...
  List<Widget> _buildProductSections(BuildContext context) => [
    ...
    if (_productWorkspacePane == _ProductWorkspacePane.tasks)
      TaskCenterSection(
        ...
        loadingTaskDetailsByNumericId: _loadingTaskDetailsByNumericId,
        ...
        taskDetailNumericIdLine: _taskDetailNumericIdLine,
        ...
        onProbeTaskDetailByNumericId: _probeTaskDetailByNumericId,
