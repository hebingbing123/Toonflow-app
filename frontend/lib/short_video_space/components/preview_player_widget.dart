...
class PreviewPlayer extends StatefulWidget {
  ...
  /// Project aspect ratio label (`9:16`, `16:9`, `1:1`).
...
class _PreviewPlayerState extends State<PreviewPlayer> {
  ...
  Widget _buildShotPicker(BuildContext context) {
    final l10n = _previewPlayerL10n(context);
    ...
    return Column(
      ...
      children: [
        Text(
          l10n.shortVideoPreviewPlayerShotPicker,
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              final shot = playlist[index];
              final selected = index == _currentShotIndex;
              return ChoiceChip(
                label: Text(
                  l10n.shortVideoPreviewPlayerShotChip(shot.shotNumber),
                ),
                selected: selected,
                onSelected: (_) => unawaited(_jumpToShot(index)),
              );
            },
          ),
        ),
            ...
            children: [
              ...
              RepaintBoundary(
                child: Container(
                  ...
                  child: AspectRatio(
                    aspectRatio: shortVideoAspectRatioFromLabel(
                      widget.videoRatio,
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: const BorderRadius.vertical(
                    bottom: Radius.circular(StudioSpacing.radiusDense),
                  ),
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
