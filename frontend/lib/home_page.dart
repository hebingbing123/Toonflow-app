...
import 'home_page/project_editor_assets/generation_workbench_support.dart';
import 'home_page/project_editor_assets/workbench_support.dart';
...
part 'home_page/project_editor_assets/images_probe.dart';
part 'home_page/project_editor_assets/crud_probe.dart';
part 'home_page/project_editor_assets/links_probe.dart';
part 'home_page/project_editor_assets/corner_scape_workbench.dart';
part 'home_page/project_editor_assets/clip_upload_workbench.dart';
part 'home_page/project_editor_assets/generation_workbench.dart';
part 'home_page/project_editor_assets/generation_workbench_dialog.dart';
part 'home_page/project_editor_assets/images_workbench.dart';
part 'home_page/project_editor_assets/workbench.dart';
part 'home_page/project_editor_novels/legacy_actions.dart';
part 'home_page/project_editor_novels/legacy_probe.dart';
part 'home_page/project_editor_novels/events_actions.dart';
part 'home_page/project_editor_novels/events_probe.dart';
part 'home_page/project_editor_novels/events_workbench.dart';
part 'home_page/project_editor_novels/workbench.dart';
part 'home_page/project_editor_novels/novels.dart';
part 'home_page/project_editor_assets/assets.dart';
part 'home_page/project_editor_assets/dialogs.dart';
...
part 'home_page/project_editor_scripts/probe.dart';
part 'home_page/project_editor_scripts/workbench.dart';
part 'home_page/project_editor_scripts/scripts.dart';
part 'home_page/projects_controller.dart';
part 'home_page/jobs/controller_list.dart';
part 'home_page/jobs/controller_summary.dart';
part 'home_page/jobs/controller_actions.dart';
...
part 'home_page/quality_reviews/controller_summary.dart';
part 'home_page/quality_reviews/controller.dart';
part 'home_page/system_probes/controller.dart';
part 'home_page/system_probes/models_catalog.dart';
part 'home_page/system_probes/models_catalog_settings_probe.dart';
part 'home_page/system_probes/models_catalog_production_probe.dart';
part 'home_page/system_probes/account_settings.dart';
part 'home_page/system_probes/account.dart';
