...
typedef ModelsCatalogL10nProvider = AppLocalizations? Function();
...
class ModelsCatalogController extends ChangeNotifier {
  ModelsCatalogController({
    ...
    required ModelsCatalogL10nProvider l10nProvider,
  ...
  final ModelsCatalogL10nProvider _l10nProvider;
  ...
  Future<void> callModelsCatalog() async {
    ...
    try {
      ...
      final emptyMarker = loc.systemProbesDataEmptyMarker;
