      ...
      child: Wrap(
        ...
        children: [
                ...
                : () async {
                    ...
                    try {
                      ...
                      ScaffoldMessenger.of(
                        ...
                        SnackBar(
                          content: Text('POST …/project/get-project：$line'),
                        ),
                      );
          ...
          TextButton(
            ...
            child: Text(
              projectLegacyBusy[0] ? 'project…' : 'POST project edit (noop)',
            ),
          ),
          TextButton(
            onPressed:
            ...
            child: Text(
              projectLegacyBusy[0] ? 'project…' : 'POST project delete id=0',
            ),
          ),
          TextButton(
            onPressed:
            ...
            child: Text(
              projectLegacyBusy[0] ? 'project…' : 'POST project edit id=0',
            ),
          ),
          TextButton(
            onPressed:
            ...
            child: Text(
              projectLegacyBusy[0] ? 'project…' : 'POST project add→del',
            ),
          ),
          TextButton(
            onPressed:
