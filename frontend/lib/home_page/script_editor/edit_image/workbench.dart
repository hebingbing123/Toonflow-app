        ...
        builder: (dialogCtx) {
          return StatefulBuilder(
            builder: (dialogCtx, setState) {
              ...
              return _buildScriptEditImageWorkbenchDialog(
                dialogCtx: dialogCtx,
                loading: loading,
                busy: busy,
                steps: steps,
                ...
                onSaveFlow: () => runMutation(setState, () async {
                  ...
                  final response = await postProductionEditImageSaveImageFlowV1(
                    token,
                    flowId: flowId,
                    steps: steps
                ...
                onUpdateStepStatus: () => runMutation(setState, () async {
                  ...
                  if (flowId.isEmpty || stepId.isEmpty || stepStatus.isEmpty) {
