  ...
  void _applySelection(Iterable<int> ids, String label) {
    ...
    setState(() {
      _selectedIds
        ..clear()
        ..addAll(next);
      _focusedAssetLegacyId =
          next.isEmpty ? _focusedAssetLegacyId : next.first;
  ...
  Future<void> _syncWorkbenchSnapshot({
    ...
    try {
      ...
      setState(() {
        ...
        _focusedAssetLegacyId =
            _selectedIds.isEmpty ? null : _selectedIds.first;
              ...
              : () => _runMutation(() async {
                  ...
                  if (mounted) {
                    setState(() {
                      ...
                      _statusLine =
                          summarizeLegacyAssetMaterialData(response);
                    });
                  }
                }),
          ...
          onPressed: _busyMutation || visible.isEmpty
              ...
              : () => _runMutation(() async {
                  final effectiveType = _selectedType.isEmpty
                      ...
                      : _selectedType;
                  final limit =
                      int.tryParse(_batchLimitCtrl.text.trim()) ?? 10;
