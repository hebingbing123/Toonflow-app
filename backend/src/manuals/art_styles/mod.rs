...
#[derive(Debug, Clone)]
pub(super) struct LocalArtStyleCover {
    pub bytes: Vec<u8>,
    pub ext: &'static str,
}
...
pub(super) fn art_style_cover_api_path(numeric_id: i32) -> String {
    format!("/api/v1/art-styles/numeric/{numeric_id}/cover")
}

pub(super) fn parse_uploaded_cover(raw: &str) -> Result<Option<LocalArtStyleCover>, ApiError> {
