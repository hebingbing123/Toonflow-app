...
#[openapi(paths(
    ...
    crate::prompting::quality::get_dashboard,
    crate::prompting::quality::post_dashboard_refresh,
    crate::prompting::quality::get_scope_insights,
    ...
    crate::prompting::quality::get_stage_grade_distribution,
    crate::prompting::quality::get_bad_case_frequency,
    crate::prompting::quality::get_bad_case_stats,
    crate::prompting::quality::get_skill_version_comparison,
    ...
    crate::prompting::benchmark::experiments::compare_ab_jobs,
    crate::prompting::benchmark::experiments::list_ab_compare_runs,
    crate::prompting::benchmark::experiments::get_ab_compare_run,
