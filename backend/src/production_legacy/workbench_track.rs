...
pub(super) struct AddTrackResponse {
    track_id: i32,
    track_name: String,
    message: &'static str,
}

pub(super) async fn post_workbench_add_track(
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(super) struct DeleteTrackBody {
    project_id: i32,
    script_id: i32,
    track_id: i32,
}
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(super) struct DeleteTrackResponse {
    track_id: i32,
    message: &'static str,
}

pub(super) async fn post_workbench_delete_track(
    State(state): State<AppState>,
    headers: HeaderMap,
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(super) struct DeleteVideoBody {
    project_id: i32,
    script_id: i32,
    storyboard_id: i32,
}
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(super) struct DeleteVideoResponse {
    storyboard_id: i32,
    message: &'static str,
}

pub(super) async fn post_workbench_delete_video(
    State(state): State<AppState>,
    headers: HeaderMap,
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub(super) struct SelectVideoBody {
    project_id: i32,
    script_id: i32,
    storyboard_id: i32,
    video_url: String,
...
#[derive(Debug, Serialize)]
#[serde(rename_all = "camelCase")]
pub(super) struct SelectVideoResponse {
    storyboard_id: i32,
    video_url: String,
    message: &'static str,
}

pub(super) async fn post_workbench_select_video(
    State(state): State<AppState>,
    headers: HeaderMap,
