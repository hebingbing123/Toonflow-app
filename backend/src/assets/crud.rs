//! REST CRUD for assets, asset images, corner-scape listing, and script-asset links.
...
use super::models::*;
use super::{
    metadata_cover_legacy_image_id, normalize_corner_types_filter,
    normalize_list_asset_type_filter, normalize_name_ilike, ADV_LOCK_ASSET_LEGACY,
...
pub(super) async fn list_project_asset_images(
    State(state): State<AppState>,
    Path((project_legacy_id, asset_legacy_id)): Path<(i32, i32)>,
    headers: HeaderMap,
...
pub(super) async fn get_project_asset_image(
    State(state): State<AppState>,
...
pub(super) async fn get_project_asset_image_file(
    State(state): State<AppState>,
    Path((project_legacy_id, asset_legacy_id, image_id)): Path<(i32, i32, Uuid)>,
    headers: HeaderMap,
...
pub(super) async fn create_project_asset_image(
    State(state): State<AppState>,
    Path((project_legacy_id, asset_legacy_id)): Path<(i32, i32)>,
    headers: HeaderMap,
...
pub(super) async fn patch_project_asset_image(
    State(state): State<AppState>,
    Path((project_legacy_id, asset_legacy_id, image_id)): Path<(i32, i32, Uuid)>,
    headers: HeaderMap,
...
pub(super) async fn delete_project_asset_image(
    State(state): State<AppState>,
    Path((project_legacy_id, asset_legacy_id, image_id)): Path<(i32, i32, Uuid)>,
    headers: HeaderMap,
) -> Result<StatusCode, ApiError> {
