...
mod stubs {
    ...
    #[utoipa::path(
        ...
        params(
            ("max_edge" = Option<u32>, Query, description = "Optional longest edge in pixels when serving locally stored PNG (64–4096). Ignored for HTTP(S) redirects to provider URLs.")
        ),
    responses(
