...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route(
            "/api/v1/projects/{project_id}/model-routing",
            get(get_project_model_routing).patch(patch_project_model_routing),
        )
        .route(
            "/api/v1/projects/{project_id}/model-routing/resolve",
            axum::routing::post(resolve_project_model_routing),
        )
        .route(
