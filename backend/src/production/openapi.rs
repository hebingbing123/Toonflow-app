...
#[openapi(
    paths(
        ...
        super::workbench::post_workbench_confirm_storyboard_candidates,
        super::workbench::voiceover::post_workbench_generate_voiceover,
        super::workbench::voiceover_preview::post_production_voiceover_preview,
        ...
        super::workbench::storyboard::mutate::post_storyboard_set_character,
