...
pub(super) fn negative_fragment_targets_identity_consistency(fragment: &str) -> bool {
...
pub(super) fn negative_prompt_scene_needs_expanded_budget(
...
pub(super) fn negative_prompt_scene_has_motion_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.shot.as_str(),
...
pub(super) fn negative_prompt_scene_has_lighting_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
...
pub(super) fn negative_prompt_scene_has_neon_reflection_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
...
pub(super) fn negative_prompt_scene_has_backlight_silhouette_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.setting.as_str(),
...
pub(super) fn negative_prompt_scene_has_flat_cold_lighting_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.setting.as_str(),
...
pub(super) fn negative_prompt_scene_has_framing_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
...
pub(super) fn negative_prompt_scene_has_shot_change_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.shot.as_str(),
...
pub(super) fn negative_prompt_scene_has_extreme_angle_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
...
pub(super) fn negative_prompt_scene_has_tight_close_up_risk(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [fields.shot.as_str(), fields.camera_move.as_str()]
        .into_iter()
...
pub(super) fn negative_prompt_scene_needs_emotional_memory(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.mood.as_str(),
...
pub(super) fn negative_prompt_scene_needs_expressive_performance_guard(
    fields: &StructuredStoryboardDescription,
) -> bool {
...
pub(super) fn negative_prompt_scene_prefers_restrained_emotional_guard(
    fields: &StructuredStoryboardDescription,
) -> bool {
    let restrained = [
        fields.mood.as_str(),
...
pub(super) fn negative_prompt_scene_intends_frantic_mood(
    fields: &StructuredStoryboardDescription,
) -> bool {
    [
        fields.mood.as_str(),
...
pub(super) fn negative_fragment_requires_strict_continuity_budget(fragment: &str) -> bool {
    let canonical = canonical_negative_fragment(fragment);
    canonical.contains("face")
        || canonical.contains("identity")
        || canonical.contains("costume")
