//! Structure and style transformation logic for video prompts
...
pub fn select_best_expressive_memory_pair_for_lean_tier(
    ...
    use super::text::memory_fragment_has_high_signal_voice_detail;
...
pub fn score_memory_fragment_against_constraint_pressure(
    ...
    use super::text::{
        generic_motion_style_fragment, memory_fragment_has_high_signal_voice_detail,
    };
