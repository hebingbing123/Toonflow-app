...
pub(in crate::production::workbench::meta::generate) use load::{
    build_video_prompt_memory_notes,
    build_video_prompt_memory_notes_with_pressure,
    load_video_prompt_memory_notes,
...
pub(in crate::production::workbench::meta::generate) use compact::{
    ...
    compact_guardrail_sensitive_style_notes,
    exact_style_note_is_low_signal_template,
    exact_style_notes_should_yield_to_role_memory,
    low_signal_local_camera_style_fragment,
    low_signal_template_style_fragment,
    preserve_delivery_pair_if_compaction_overtrims,
    preserve_runtime_exact_camera_fragment,
    restore_runtime_exact_style_note_fragments,
