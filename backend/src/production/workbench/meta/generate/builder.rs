...
pub(super) use super::builder_parts::continuity::compose::build_continuity_notes;
...
use super::builder_parts::coverage::{
    collect_prompt_coverage, fragment_mostly_repeats_prompt_mood,
    trim_fragment_by_exact_field_overlap,
};
use super::builder_parts::quality_tail::build_video_prompt_quality_tail;
use super::builder_parts::quality_tail::continuity_tail_matches;
use super::*;
...
// moved to `builder_parts/coverage.rs`

// moved to `builder_parts/continuity/compose.rs`
// moved to `builder_parts/continuity_pressure.rs`
// moved to `builder_parts/continuity/compact.rs`

// moved to `builder_parts/clauses/`
...
use super::builder_parts::clauses::dialogue::{
    compact_dialogue_clause, dialogue_clause_is_low_gain_for_offscreen_or_low_visibility_speech,
};
use super::builder_parts::clauses::sound::{
    compact_sound_clause, sound_fragment_has_high_value_acoustic_detail,
};
pub(super) use super::builder_parts::coverage::{
    canonical_prompt_fragment, prompt_fragment_is_covered,
};
use super::builder_parts::coverage::{
    extend_prompt_coverage, prompt_style_field_is_covered, style_fragment_semantically_covers_field,
};
...
// moved to `builder_parts/clauses/dialogue.rs` and `builder_parts/clauses/sound.rs`
